 ...
 * 
 * 
 * This is  a Pawn class, one of the subclasses of a ChessPiece Class containing two abstract methods. This class defines pawn piece from the chess game, 
 * and it has the ability to move one square ahead of its position, though with its first move it is allowed to move two squares ahead of its 
 * position also called El-peasant.
 * It has the ability to take out the opposite color that resides one square diagonally from its current position coordinates.
 *
 *@author Imran Syed.
 */
